...
class GoogleSubscribeService extends AbstractSubscibeService
{
    ...
    {
        return $this->render('VeniceFrontBundle::GoogleSubscribeService:generateSubscribeButton.html.twig');
    }

    public function renderLogInButton()
    {
        return $this->render('VeniceFrontBundle:GoogleSubscribeService:generateLogInButton.html.twig');
    }
    public function renderRemoveButton()
    {
        return $this->render('VeniceFrontBundle:GoogleSubscribeService:generateRemoveButton.html.twig');
    }
...
//    }
    ...
    {
        return $this->render('@VeniceFrontBundle::GoogleSubscribeService/init.html.twig');
    }
